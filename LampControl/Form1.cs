...
namespace LampControl
{
    public partial class Form1 : Form
    {
        ...
        private void sensorDataReceivedEventHandler1(object sender, SerialDataReceivedEventArgs e)
        {
        ...
        private void populateSensorFrom()
        {
            txtTemp1.Text = sr[0].Temperature.ToString();
        ...
        {
            sr = parent.readSensorData(serialPort1);
            //sr =parent.extractSensorData(buffer);
            populateSensorFrom();
        }
